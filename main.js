...
function start(){
  ...
  const encounterSets=selectedCharacter==='orange'?{toshio:[.14,.78],kayako:[.34],sadako:[.53],slit:[.27,.76],freddy:[.69],edward:[.39,.88],jiangchen:[.86]}:selectedCharacter==='yellow'?{toshio:[.11,.28,.47,.66,.86],kayako:[.27,.49,.69,.88],sadako:[.48,.68,.87],slit:[.22,.44,.72,.91],freddy:[.64,.76,.9],edward:[.34,.58,.78,.94],jiangchen:[.82,.9,.97]}:{toshio:[.1,.25,.42,.62,.82,.94],kayako:[.24,.43,.63,.83,.95],sadako:[.42,.61,.81,.94],slit:[.18,.35,.54,.73,.89,.97],freddy:[.62,.71,.82,.91,.97],edward:[.32,.47,.64,.78,.9,.97],jiangchen:[.81,.88,.94,.98]};toshioRatios=encounterSets.toshio;kayakoRatios=encounterSets.kayako;sadakoRatios=encounterSets.sadako;slitRatios=encounterSets.slit;freddyRatios=encounterSets.freddy;edwardRatios=encounterSets.edward;jiangchenRatios=encounterSets.jiangchen;freddyIndex=0;edwardIndex=0;jiangchenIndex=0;freddyUntil=0;edwardStage=0;edwardStageAt=0;jiangchenUntil=0;[freddy,jiangchen,edwardRipper,dreamClock].forEach(actor=>{actor.visible=false;actor.position.y=.05;actor.rotation.set(0,0,0);actor.scale.setScalar(1);actor.userData.taunted=false;});freddy.userData.pounce=null;jiangchen.userData.pounce=null;
