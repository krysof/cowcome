...
function makeSafeZone(index){
  ...
  for(const z of [-19,19]){for(const x of [-20,-12,-4,4,12,20])mesh(new THREE.CylinderGeometry(.28,.38,4.5,5),wood,group,x,2.25,z);mesh(new THREE.BoxGeometry(7,1,1),wood,group,0,7,z);for(const x of [-3.5,3.5])mesh(new THREE.BoxGeometry(.8,8,1),wood,group,x,4,z);}
